      ...
      <div className="max-w-7xl mx-auto px-6 py-12 lg:px-8 lg:py-20">
            ...
            <div className="relative z-10">
              ...
              <div className="relative">
                ...
                <button 
                  ...
                  className="absolute top-4 right-4 px-6 py-3 bg-white text-slate-900 hover:bg-indigo-50 rounded-2xl transition-all font-black text-[10px] uppercase tracking-widest flex items-center space-x-2 shadow-2xl"
                >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-slate-900 rounded-[3rem] p-12 text-white relative overflow-hidden group">
            ...
            <p className="text-slate-400 font-medium mb-10 relative z-10 max-w-sm">
          ...
          <div className="bg-rose-50 rounded-[3rem] p-12 border border-rose-100 flex flex-col justify-between">
            <div>
              <div className="flex items-center space-x-3 mb-8">
                ...
                <h3 className="text-2xl font-black text-rose-950 tracking-tight">Installation Checklist</h3>
              </div>
              <ul className="space-y-4">
                {[
                  "Wait for the script to load (using async)",
                  "Check your browser console for CSP errors",
                  "Ensure domain is not blocked by ad-blockers",
                  "Verify your Bot ID is correctly formatted"
                ].map((check, i) => (
            ...
            <div className="mt-10 p-5 bg-white/50 rounded-2xl border border-rose-200">
              <p className="text-[10px] font-black text-rose-900 uppercase tracking-widest">System Status</p>
              <div className="flex items-center mt-1">
                <div className="w-2 h-2 bg-emerald-500 rounded-full mr-2" />
                <span className="text-[10px] font-bold text-slate-900 tracking-tight">All Delivery Nodes Operational</span>
              </div>
            </div>
          </div>
        </div>
