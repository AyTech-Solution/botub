        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex items-center group">
              <Logo iconOnly className="w-9 h-9 group-hover:rotate-12 transition-transform" />
              <div className="ml-2.5">
                <span className="block text-xl font-black text-slate-900 leading-none tracking-tight">Botub</span>
                <span className="block text-[9px] font-bold text-indigo-600 uppercase tracking-widest mt-1">AI Engine</span>
              </div>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            {user ? (
              <div className="flex items-center space-x-4">
                ...
                <Link to="/account-settings" className="px-3 py-1 bg-indigo-50 text-indigo-600 rounded-lg text-xs font-bold uppercase tracking-widest flex items-center hover:bg-indigo-100 transition-colors">
